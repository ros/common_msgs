"""autogenerated by genmsg_py from InteractiveMarkerArray.msg. Do not edit."""
...
class InteractiveMarkerArray(roslib.message.Message):
  _md5sum = "28632cc6259a3f6ce0186b8b1012c994"
  _type = "visualization_msgs/InteractiveMarkerArray"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Note: when sending an interactive marker array, it is important
...
"""
  __slots__ = ['markers']
  _slot_types = ['visualization_msgs/InteractiveMarker[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(InteractiveMarkerArray, self).__init__(*args, **kwds)
